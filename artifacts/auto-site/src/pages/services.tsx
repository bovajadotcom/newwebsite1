...
function AddonRow({
  checked, onChange, label, price, desc,
...
export default function Services() {
  ...
  const toggleSourcing = (key: keyof Addons) =>
    setSourcingAddons(a => ({ ...a, [key]: !a[key] }));
  const toggleStock = (key: keyof Addons) =>
    setStockAddons(a => ({ ...a, [key]: !a[key] }));
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 items-start">
            ...
            >
              ...
              <div className="border-t border-white/[0.06] pt-4 mb-5">
                ...
                <div className="space-y-2">
                  <AddonRow
                    checked={sourcingAddons.export}
                    onChange={() => toggleSourcing("export")}
                    label={t("services.addons.export.title")}
                    price={t("services.addons.export.price")}
                    desc={t("services.addons.export.desc")}
                  />
                  <AddonRow
                    checked={sourcingAddons.belarus}
                    onChange={() => toggleSourcing("belarus")}
                    label={t("services.addons.belarus.title")}
                    price={t("services.addons.belarus.price")}
                    desc={t("services.addons.belarus.desc")}
                  />
                </div>
              </div>

              <Link
                href={buildContactUrl("sourcing", sourcingAddons)}
            ...
            >
              ...
              <div className="border-t border-white/[0.06] pt-4 mb-5">
                ...
                <div className="space-y-2">
                  <AddonRow
                    checked={stockAddons.export}
                    onChange={() => toggleStock("export")}
                    label={t("services.addons.export.title")}
                    price={t("services.addons.export.price")}
                    desc={t("services.addons.export.desc")}
                  />
                  <AddonRow
                    checked={stockAddons.belarus}
                    onChange={() => toggleStock("belarus")}
                    label={t("services.addons.belarus.title")}
                    price={t("services.addons.belarus.price")}
                    desc={t("services.addons.belarus.desc")}
                  />
              ...
              <Link
                href={buildContactUrl("stock", stockAddons)}
