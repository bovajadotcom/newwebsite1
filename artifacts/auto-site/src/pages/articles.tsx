      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-semibold mb-5">
            <Newspaper size={14} /> Articles & Guides
          </span>
          <h1 className="text-4xl md:text-5xl font-black text-white mb-4">Latest News &amp; Articles</h1>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Helpful guides, market insights, and tips for importing and buying vehicles from Europe.
          </p>
        </motion.div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-24 text-muted-foreground">
            ...
            <p className="text-lg">No articles have been published yet.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
