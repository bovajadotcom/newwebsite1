...
export const popularVehicles: PopularVehicle[] = [
  { id: "p1", make: "Toyota", model: "Land Cruiser 300", image: "vehicle-4.png", priceRange: "€75,000 – €95,000", estimatedDelivery: "6–9", description: "The most in-demand import from Japan. Exceptional reliability, off-road capability, and resale value." },
  { id: "p2", make: "Porsche", model: "Cayenne / Cayenne S", image: "vehicle-1.png", priceRange: "€80,000 – €140,000", estimatedDelivery: "4–7", description: "Premium German SUV with outstanding performance and prestige. Popular from both Germany and Japan." },
  { id: "p3", make: "BMW", model: "M5 / M3 Competition", image: "vehicle-2.png", priceRange: "€75,000 – €110,000", estimatedDelivery: "4–6", description: "The benchmark sports sedan. German market vehicles offer the widest spec availability." },
  { id: "p4", make: "Mercedes-Benz", model: "G63 AMG / GLE", image: "vehicle-3.png", priceRange: "€90,000 – €220,000", estimatedDelivery: "5–8", description: "Iconic SUV lineup. G-Class commands a premium worldwide; GLE remains the #1 choice for families." },
  { id: "p5", make: "Lexus", model: "LX 600 / GX 460", image: "vehicle-1.png", priceRange: "€55,000 – €145,000", estimatedDelivery: "6–10", description: "Toyota reliability in a premium package. Japan-spec LX600 is exceptionally difficult to source elsewhere." },
  { id: "p6", make: "Tesla", model: "Model S / Model X", image: "vehicle-4.png", priceRange: "€70,000 – €110,000", estimatedDelivery: "3–5", description: "The premier EV import. US-spec Teslas offer the most complete feature set and best pricing." },
];